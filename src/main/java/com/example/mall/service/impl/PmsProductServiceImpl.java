...
//    private CmsPrefrenceAreaProductRelationDao prefrenceAreaProductRelationDao;
    ...
    @Autowired
    private BesProductDao productDao;
//    @Autowired
...
//        relateAndInsertList(prefrenceAreaProductRelationDao, productParam.getPrefrenceAreaProductRelationList(), productId);
    ...
    @Override
    public int getProductByBesCount(Map<String, Object> map) {
        return productMapper.getProductByBesCount(map);
    }
...
//        relateAndInsertList(prefrenceAreaProductRelationDao, productParam.getPrefrenceAreaProductRelationList(), id);
    ...
    @Override
    public PageInfo<PmsProduct> list(PmsProductQueryParam productQueryParam, Integer pageSize, Integer pageNum) {
        PmsProductExample productExample = new PmsProductExample();
        productExample.setPage((pageNum-1) * pageSize);
        productExample.setLimit(pageSize);
        PmsProductExample.Criteria criteria = productExample.createCriteria();
        criteria.andDeleteStatusEqualTo(0);
        if (productQueryParam.getBesId() != null) {
            criteria.andBesIDqualTo(productQueryParam.getBesId());
        }
        ...
        for(PmsProduct p:list){
            p.setGiftPoint(p.getGiftPoint().multiply(b100));
        }
        PageInfo<PmsProduct>  page= new PageInfo(list);
...
//        productVertifyRecordDao.insertList(list);
    ...
    @Override
    public List<PmsProduct> getlistbycate(Map<String,Object> map) {
        return productMapper.getlistbycate(map);
    }

    @Override
    public int getCountPros(Map<String, Object> map) {
        return productMapper.getCountPros(map);
    }

    @Override
    public List<PmsProduct> getProductByBes(Map<String,Object> map) {
        return productMapper.getProductByBes(map);
    }

    @Override
    public int updateJFrate(Map<String,Object> map) {
        return productMapper.updateJFrate(map);
    }
