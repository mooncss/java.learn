...
public class OmsOrder implements Serializable {
    ...
    @ApiModelProperty(value = "订单头部 TH开头")
    @TableField("order_th")
    ...
    @ApiModelProperty(value = "支付方式：0->余额支付；1->支付宝；2->微信;")
    private Integer payType;

    @ApiModelProperty(value = "订单来源：0->PC订单；1->app订单")
    private Integer sourceType;

    @ApiModelProperty(value = "订单状态：0->待付款；1->待发货；2->已发货；3->已完成/收货；4->已关闭；5->无效订单")
    private Integer status;

    @ApiModelProperty(value = "订单类型：0->正常订单；1->秒杀订单；2 拼团订单")
    private Integer orderType;

    @ApiModelProperty(value = "配送方式 0 商家配送 1自提")
    ...
    private String groupId; //团的ID

    @ApiModelProperty(value = "是否是发起人 0发起人 1否")
    private Integer isPrime; //是否是发起人

    //拼团的状态
    @ApiModelProperty(value = "拼团状态 7待成团 8成功 9失败")
    ...
    @ApiModelProperty(value = "是否新订单  0 是新订单")
    @TableField("is_new")
    private Integer isNew;

    @ApiModelProperty(value = "商品到达或离开驿站  5 到达 6 离开")
    @TableField("stage_status")
    private Integer stageStatus;

    @ApiModelProperty(value = "订单内的商品名，拼接后的字符串")
    ...
    public String getOrderTh() {
        return orderTh;
    }

    public void setOrderTh(String orderTh) {
