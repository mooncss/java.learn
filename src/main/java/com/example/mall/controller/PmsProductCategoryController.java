...
//    @PreAuthorize("hasAuthority('pms:productCategory:read')")
    public CommonResult<CommonPage<PmsProductCategory>> getList(@PathVariable Long parentId,
        ...
        CommonPage<PmsProductCategory> com = CommonPage.restPage(productCategoryList);
        com.setList(com.getList().subList((pageNum-1)*pageSize,
                pageNum*pageSize-1>=com.getTotal().intValue()-1?com.getTotal().intValue():pageNum*pageSize));
