...
import com.zhihui.uj.management.utils.OssUtil;
 ...
 */
@Controller
@Api(tags = "SmsHomeAdvertiseController", description = "商城首页轮播广告管理")
...
public class SmsHomeAdvertiseController {
    ...
    public CommonResult update(@PathVariable Long id, @RequestBody SmsHomeAdvertise advertise) {
        SmsHomeAdvertise old = advertiseService.getItem(id);
        String url = old.getUrl();
        if(!url.equals(advertise.getUrl())){
            OssUtil.delObject(url); //删除老图
        }
